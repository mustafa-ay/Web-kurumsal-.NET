...
namespace RitechWeb.Controllers
{
    public class IletisimController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IletisimId,Adres,Telefon,Fax,Whatsapp,Facebook,Twitter,İnstagram")] Iletisim iletisim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IletisimId,Adres,Telefon,Fax,Whatsapp,Facebook,Twitter,İnstagram")] Iletisim iletisim)
        {
            if (ModelState.IsValid)
            {
